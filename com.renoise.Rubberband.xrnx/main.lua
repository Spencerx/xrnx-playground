...
function process_stretch(stretch)
  if stretch > 100 then
...
function process_shift(shift, preserve_formant)
  local cmd = "--fine --pitch "..shift;
...
function show_shift_dialog()
  ...
  if res == 'Shift' then
    process_shift(semitone_selector.value + (cent_selector.value / 100), formant_selector.value)
  end;
end
...
function show_stretch_dialog()
  ...
  process_stretch(real_stretch_factor)
end
--------------------------------------------------------------------------------
